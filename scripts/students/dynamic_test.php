...
$_SESSION['paper_size']=25;
$minimum_questions=100;
//$_SESSION['paper_size']=10;
?>
<!doctype html>
<html>
<head>
...
<body>
	...
	<div id="content" >
		...
		<form id="form1" name="form1" method="post" action="dynamic_test_process.php">
								...
								<table width="600" >
									<tr>
										<td colspan="2"><div align="center"><strong><h3>Test Selection Form</h3></strong></div></td>
									</tr>
									<tr>
										<td colspan="2"></td>
									</tr>
									<tr>
										<td width="177"><strong>Subject:</strong></td>
										<td width="178"><label for="select"></label>
											<select name="subject_name" id="subject_name" required="required">
