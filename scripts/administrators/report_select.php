...
<body>
	...
	<div id="index_left_sidebar" >
		...
		<div id="menu">
			<ul id="nav">
                	<li><a href="student.php">Pupil Reports</a></li>
					<li><a href="analysis.php">Analysis</a></li>
					<li><a href="reset_password.php">ResetPupilPass</a></li>
					<li><a href="change_password.php">Reset My Pass</a></li>
	...
	<div id="content" >
		<div id="message_banner">  
			...
			<form id="form1" name="form1" method="post" action="topic_select_frm.php">
								...
								<table width="600" >
									<tr>
										<td colspan="2"><div align="center"><strong><h3>Exercise Selection Form</h3></strong></div></td>
									</tr>
									<tr>
										<td colspan="2">&nbsp;</td>
									</tr>
									...
									<tr>
										...
										<td width="178">
											<select name="paper_type" id="paper_type" required="required">
												...
												<option value="2">Structured Questions</option>	
											</select>     						
										</td>
									</tr>
