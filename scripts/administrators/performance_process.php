...
$_SESSION['paper_description']="GRADE"." ".$_SESSION['grade']." ".$_SESSION['subject_name']." ".$_SESSION['topic_name'];
...
if ($_SESSION['paper_type']==1){
	...
	header ("Location:mc/mc_ind_questions.php");
	exit;
}
...
if ($_SESSION['paper_type']==2){
	...
	header ("Location:sq/sq_ind_questions.php");
	exit;			
}
?>
